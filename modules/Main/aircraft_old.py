...
class data(object):
	...
	def __init__(self):
		...
		self.FMA = FMA_c() #Flight Mode Announciator
		self.AP = autopilot.AP_c(self.attitude, self.global_time, self)
	...
	#	self.ADF2 = ADF_c("ADF2")
		...
		self.Com_1 = Radio_c(1,True)
		self.Com_2 = Radio_c(2,False)
		self.Nav_1 = Radio_c(1,False)
		self.Nav_2 = Radio_c(2,False)
		
		self.swap_com1 = event_obj(0)
		self.swap_com2 = event_obj(0)
		self.swap_nav1 = event_obj(0)
		self.swap_nav2 = event_obj(0)

		self.whole_inc_com1 = event_obj(0)
		self.fract_inc_com1 = event_obj(0)
		self.whole_dec_com1 = event_obj(0)
		self.fract_dec_com1 = event_obj(0)
		
		self.whole_inc_com2 = event_obj(0)
		self.fract_inc_com2 = event_obj(0)
		self.whole_dec_com2 = event_obj(0)
		self.fract_dec_com2 = event_obj(0)
		
		self.whole_inc_nav1 = event_obj(0)
		self.fract_inc_nav1 = event_obj(0)
		self.whole_dec_nav1 = event_obj(0)
		self.fract_dec_nav1 = event_obj(0)
		
		self.whole_inc_nav2 = event_obj(0)
		self.fract_inc_nav2 = event_obj(0)
		self.whole_dec_nav2 = event_obj(0)
		self.fract_dec_nav2 = event_obj(0)
		...
		self.Latitude = data_obj(math.radians(37.613))
		self.Longitude = data_obj(math.radians(-122.357))
...
#		self.LatLong = (0.73675821079214898, -1.4550227732038261)
		...
		self.variables = variable.variable_c(self) #Must be at end.
		self.events = event.event_c(self)
	
	def setup_GlassServer(self):
		self.glass = GlassServer.Glass_Server_c(self, self.variables, self.events)
		#self.glass.start()
	...
	def setup_Client(self, left_screen, right_screen):
		...
		import GlassClient
		self.client = GlassClient.client('127.0.0.1', config.server_port, self.variables)
		self.client.connect()
		#Send variables that need to be watched to GlassServer
		self.client.watch_vars([left_screen, right_screen])
	...
	def setup_SimConnect(self, FSX_version):
		...
		#radio
		self.s.definition_0.add("COM ACTIVE FREQUENCY:1", "MHZ", FLOAT64, self.Com_1.Active)
		self.s.definition_0.add("COM STANDBY FREQUENCY:1", "MHZ", FLOAT64, self.Com_1.Standby)
		self.s.definition_0.add("COM ACTIVE FREQUENCY:2", "MHZ", FLOAT64, self.Com_2.Active)
		self.s.definition_0.add("COM STANDBY FREQUENCY:2", "MHZ", FLOAT64, self.Com_2.Standby)
		self.s.definition_0.add("NAV ACTIVE FREQUENCY:1", "MHZ", FLOAT64, self.Nav_1.Active)
		self.s.definition_0.add("NAV STANDBY FREQUENCY:1", "MHZ", FLOAT64, self.Nav_1.Standby)
		self.s.definition_0.add("NAV ACTIVE FREQUENCY:2", "MHZ", FLOAT64, self.Nav_2.Active)
		self.s.definition_0.add("NAV STANDBY FREQUENCY:2", "MHZ", FLOAT64, self.Nav_2.Standby)
		...
		self.sevent.eventlist.add("COM_STBY_RADIO_SWAP", self.swap_com1)
		self.sevent.eventlist.add("COM2_RADIO_SWAP", self.swap_com2)
		self.sevent.eventlist.add("NAV1_RADIO_SWAP", self.swap_nav1)
		self.sevent.eventlist.add("NAV2_RADIO_SWAP", self.swap_nav2)

		self.sevent.eventlist.add("COM_RADIO_WHOLE_INC", self.whole_inc_com1)
		self.sevent.eventlist.add("COM_RADIO_FRACT_INC", self.fract_inc_com1)
		self.sevent.eventlist.add("COM_RADIO_WHOLE_DEC", self.whole_dec_com1)
		self.sevent.eventlist.add("COM_RADIO_FRACT_DEC", self.fract_dec_com1)

		self.sevent.eventlist.add("COM2_RADIO_WHOLE_INC", self.whole_inc_com2)
		self.sevent.eventlist.add("COM2_RADIO_FRACT_INC", self.fract_inc_com2)
		self.sevent.eventlist.add("COM2_RADIO_WHOLE_DEC", self.whole_dec_com2)
		self.sevent.eventlist.add("COM2_RADIO_FRACT_DEC", self.fract_dec_com2)

		self.sevent.eventlist.add("NAV1_RADIO_WHOLE_INC", self.whole_inc_nav1)
		self.sevent.eventlist.add("NAV1_RADIO_FRACT_INC", self.fract_inc_nav1)
		self.sevent.eventlist.add("NAV1_RADIO_WHOLE_DEC", self.whole_dec_nav1)
		self.sevent.eventlist.add("NAV1_RADIO_FRACT_DEC", self.fract_dec_nav1)
		#self.sevent.group1.add("AP_ALT_VAR_SET_ENGLISH", self.TEST2)
		self.sevent.eventlist.add("NAV2_RADIO_WHOLE_INC", self.whole_inc_nav2)
		self.sevent.eventlist.add("NAV2_RADIO_FRACT_INC", self.fract_inc_nav2)
		self.sevent.eventlist.add("NAV2_RADIO_WHOLE_DEC", self.whole_dec_nav2)
		self.sevent.eventlist.add("NAV2_RADIO_FRACT_DEC", self.fract_dec_nav2)
		#self.sevent.group1.add("AP_ALT_VAR_INC", self.TEST2)
		#Speed Bug Event
		self.sevent.eventlist.add("AP_SPD_VAR_SET", self.airspeed.bug)
		#Nav1 Event
		self.sevent.eventlist.add("NAV1_RADIO_SET", self.Nav_1.Active, freqtoBCD)
		self.sevent.eventlist.add("NAV1_STBY_SET", self.Nav_1.Standby, freqtoBCD)
		self.sevent.eventlist.add("NAV2_RADIO_SET", self.Nav_2.Active, freqtoBCD)
		self.sevent.eventlist.add("NAV2_STBY_SET", self.Nav_2.Standby, freqtoBCD)
		#Coms
		self.sevent.eventlist.add("COM_RADIO_SET", self.Com_1.Active, freqtoBCD)
		self.sevent.eventlist.add("COM_STBY_RADIO_SET", self.Com_1.Standby, freqtoBCD)
		self.sevent.eventlist.add("COM2_RADIO_SET", self.Com_2.Active, freqtoBCD)
		self.sevent.eventlist.add("COM2_STBY_RADIO_SET", self.Com_2.Standby, freqtoBCD)
	...
	def get_mode_func(self, mode, right_screen= None, left_screen= None):
		if mode==config.TEST: 
			mode_func = self.test
	...
	def test(self):
		...
		#self.Com_1.Active.value = 128.300
		#self.Com_1.Standby.value = 118.275
		#self.Com_2.Active.value = 128.300
		#self.Com_2.Standby.value = 118.275
...
#		self.altimeter.absolute.value = 10
		if self.count >=0:
			...
			self.altimeter.indicated.value = self.altimeter.indicated.value + 1
			self.airspeed.IAS.value -=0.5
